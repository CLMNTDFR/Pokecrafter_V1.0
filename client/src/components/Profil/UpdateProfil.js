            ...
            <div className="update-container">
                ...
                <div className="right-part">
                    ...
                    <h5 onClick={() => setFollowingPopup(true)}>
                        <img src="/img/icons/following.svg" alt="following icon" className="icon" />
                        Following: {userData.following ? userData.following.length : ""}
                    </h5>
                    <h5 onClick={() => setFollowersPopup(true)}>
                        <img src="/img/icons/followers.svg" alt="followers icon" className="icon" />
                ...
                <div className="popup-profil-container">
                    <div className="modal">
                        ...
                        {usersData
                            ...
                            .map((user) => ( // Map uniquement sur les utilisateurs filtrés
                                <li key={user._id}>
                                <img src={user.picture} alt="user-profil-picture" />
                                <h4>{user.username}</h4>
                                <h6>FOLLOW HANDLER</h6>
                                </li>
                            ))
                        }
                        </ul>
